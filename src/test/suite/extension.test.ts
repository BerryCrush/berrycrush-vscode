...
suite('BerryCrush Extension Test Suite', () => {
    ...
    test('Extension should be present', () => {
        assert.ok(vscode.extensions.getExtension('berrycrush.berrycrush'));
    });

    test('Extension should activate on scenario file', async () => {
        const ext = vscode.extensions.getExtension('berrycrush.berrycrush');
        if (ext) {
            await ext.activate();
